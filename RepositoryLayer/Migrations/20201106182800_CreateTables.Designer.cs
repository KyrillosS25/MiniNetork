...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataAccessLayer.Entities.React", b =>
                {
                    b.Property<int>("PersonId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DataAccessLayer.Entities.Friendship", b =>
                {
                    b.HasOne("DataAccessLayer.Entities.Person", "Friend")
                        .WithMany()
            ...
            modelBuilder.Entity("DataAccessLayer.Entities.Person", b =>
                {
                    b.HasOne("DataAccessLayer.Entities.ApplicationUser", "User")
                        .WithOne("Person")
                        .HasForeignKey("DataAccessLayer.Entities.Person", "UserId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
